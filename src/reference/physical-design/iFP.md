...
![图片.png](./iFP/fig.3.png)

（3）在可执行程序后，添加json脚本路径参数，执行脚本中的内容
![图片.png](./iFP/fig.4.png)
